...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, SPI_NS_Pin|SR04_TRIG_Pin|OLED_SDA_Pin|OLED_SCL_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SPI_NS_Pin SR04_TRIG_Pin */
  GPIO_InitStruct.Pin = SPI_NS_Pin|SR04_TRIG_Pin;
